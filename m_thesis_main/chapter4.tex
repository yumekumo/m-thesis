...
初期温度$t$は，考えられるスコアの最大値$-$最小値に近い値を設定する．
スコアの最小値は全てのケースで$1$を下回ることはない．
考えられるスコアの最大値は次のように求める．
まず，グラフの頂点重みを昇順にソートしたものを$w'_1,\ldots,w'_n$とおく．
考えられる部分グラフの最大重みは$\sum_{i=d}^n w’_i$，最小重みは$w’_1$であるから，
スコアの最大値は，$(\sum_{i=d}^n w'_i)/w'_1$となる．
よって，初期温度は$t=((\sum_{i=d}^n w'_i)/w'_1) - 1$と定める．
